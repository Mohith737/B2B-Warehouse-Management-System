...
Seed users:
- Admin: `admin@stockbridge.com` / `StockAdmin123!`
- Procurement Manager: `manager@stockbridge.com` / `StockManager123!`
- Warehouse Staff: `staff@stockbridge.com` / `StockStaff123!`
